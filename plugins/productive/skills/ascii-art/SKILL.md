...
ถามทั้งหมดนี้ใน `AskUserQuestion` **ครั้งเดียว** — เครื่องมือรับได้ถึง 4 คำถามต่อครั้งและ
แสดงพร้อมกันในหน้าจอเดียว ผู้ใช้จึงตอบรวดเดียวจบ ไม่ใช่ถามฟอนต์ รอตอบ แล้วค่อยถามสี
รอตอบ ซึ่งจะกลายเป็น 4 รอบสำหรับงานที่ควรใช้ 2
