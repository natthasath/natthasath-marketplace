...
- **ผลลัพธ์ออกที่เทอร์มินัลเท่านั้น ไม่ต้องเซฟไฟล์** — ผู้ใช้ต้องการเห็นผลทันทีตอนรัน
  ไม่ใช่ได้ path มาแล้วต้องไปเปิดเอง อย่าเสนอให้บันทึกเป็นไฟล์เว้นแต่เขาขอเอง
